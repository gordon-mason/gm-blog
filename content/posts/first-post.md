...
One thing I've learned: It's important not to over-engineer solutions (Keep It Simple, Stupid). We want something that's straight forward and flexible enough for future requirements.  

I've opted to use Hugo static site generator for this blog, deployed with Netlify. The GitHub integration made it simple to get a site running within minutes.
